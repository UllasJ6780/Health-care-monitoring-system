...
%>
  <form name="form1"  method="post" action="doctor" onSubmit="return valid(this)" enctype="Multipart/form-data" >
  <p align="center"><strong><font color="#003399" size="5" face="Times New Roman">Doctor Registration </font></strong></p>
  ...
  <table width="381" border="0" align="center" cellpadding="2" cellspacing="2">
    ...
    <tr> 
      <td><div align="center"><font size="4" face="Times New Roman"><em><strong>Specialization</strong></em></font></div></td>
       <td><font size="5"> 
        <input name="spec" type="spec" id="spec"/>
        </font></td>
    </tr>
     <tr> 
      <td><div align="center"><font size="4" face="Times New Roman"><em><strong>Experience</strong></em></font></div></td>
       <td><font size="5"> 
    ...
    <tr> 
      <td><div align="center"><font size="4" face="Times New Roman"><em><strong>Available-Time</strong></em></font></div></td>
       <td><font size="5"> 
        <input name="time" type="time" id="time"/>
        </font></td>
    </tr>
    <tr> 
      <td><div align="center"><font size="4" face="Times New Roman"><em><strong>Treatment</strong></em></font></div></td>
       <td><font size="5"> 
        <input name="trt" type="trt" id="trt"/>
        </font></td>
    </tr>
     <tr> 
      <td><div align="center"><font size="4" face="Times New Roman"><em><strong>Salary</strong></em></font></div></td>
       <td><font size="5"> 
        <input name="sal" type="text" id="sal"/>
        </font></td>
    </tr>
    <tr> 
