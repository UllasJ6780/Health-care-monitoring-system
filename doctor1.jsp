...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="doctor1.jsp">Patient</a></li>
    ...
    <section id="about-us" >
        ...
        <table width="381" border="0" align="left" cellpadding="2" cellspacing="2" style="margin-right: -241px;">
    <tr> 
      ...
      <td width="192"><font size="5"> 
          ...
          <%
              while(res.next()){
                             if(myid.equals(res.getString(9))){
            %>
