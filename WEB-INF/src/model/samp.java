...
public static String retval="";
    ...
    public static String SMSSender(String user,String password,String msisdn,String msg,String sid,String fl)    
    {
        ...
        try {
            ...
            String data1= "user=manjutechnosoft&password=manju12345&msisdn=919731929530&sid=TECHNO&msg=your%20updated%20prescription%20is%20"+msg+"%20MSG%20FRM%20SMSLANE%20Thank%20u.&fl=0&gwid=2";
    ...
    public static void sendsms(String contact,String msg) {        
        String response = SMSSender("manjutechnosoft", "manju12345", "919731929530", "200mg gx", "TECHNO", "0");        
