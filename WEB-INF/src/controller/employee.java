    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String id1 = null;
        ...
        try {
            ...
            MultipartRequest multi = new MultipartRequest(request,contextPath+"\\images\\photos\\employee\\",1024*1024*5);
            ...
            while(en.hasMoreElements()){
                ...
                if(parm.equals("deg")){
                    desg = multi.getParameter(parm);
                }
                if(parm.equals("sal")){
                    salary = multi.getParameter(parm);
                }
                if(parm.equals("dut")){
                    duty_hour = multi.getParameter(parm);
                }
            ...
            data.employee(id1,name,dob,adr,cont,email,gender,desg,salary,duty_hour,imagename);
