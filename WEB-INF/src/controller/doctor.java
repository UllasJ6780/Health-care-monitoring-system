...
public class doctor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            MultipartRequest multi = new MultipartRequest(request,contextPath+"\\images\\photos\\doctor\\",1024*1024*5);
            ...
            while(en.hasMoreElements()){
                ...
                if(parm.equals("spec")){
                    spec = multi.getParameter(parm);
                }
                if(parm.equals("exp")){
                    exp = multi.getParameter(parm);
                }
                if(parm.equals("dob")){
                ...
                if(parm.equals("time")){
                    atime = multi.getParameter(parm);
                }
                if(parm.equals("trt")){
                    treat = multi.getParameter(parm);
                }
                if(parm.equals("sal")){
                	sal = multi.getParameter("sal");
                }
             ...
             while(en1.hasMoreElements()){
                 ...
                 imagename = multi.getFile(myimg).getName();
             }
             System.out.println(imagename);
            data.doctor(id1,name,spec,exp,dob,adr,cont,email,gender,atime,treat,imagename,sal);
