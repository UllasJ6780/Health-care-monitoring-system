...
<head>
    ...
    <title>Employee_Profile | Health Record</title>
...
<body>
    ...
    <section id="about-us" >
        ...
        <table width="381" border="2" align="center" cellpadding="2" cellspacing="2">
            ...
            <tr><td width="165"><div align="center"><font size="5" face="Times New Roman, Times, serif"><em><strong>ID</strong></em></font></div></td><td><font size="5" face="Times New Roman, Times, serif"><em><strong><%=rs.getInt(1)%></strong></em></font></td><td rowspan="5"><img src='images/photos/employee/<%=rs.getString(11)%>' width="200px" height="200px"/></td></tr>
            ...
            <tr><td width="165"><div align="center"><font size="5" face="Times New Roman, Times, serif"><em><strong>Designation</strong></em></font></div></td><td><font size="5" face="Times New Roman, Times, serif"><em><strong><%=rs.getString(8)%></strong></em></font></td></tr>
            <tr><td width="165"><div align="center"><font size="5" face="Times New Roman, Times, serif"><em><strong>Salary</strong></em></font></div></td><td><font size="5" face="Times New Roman, Times, serif"><em><strong><%=rs.getString(9)%></strong></em></font></td></tr>
            <tr><td width="165"><div align="center"><font size="5" face="Times New Roman, Times, serif"><em><strong>Duty Hours</strong></em></font></div></td><td><font size="5" face="Times New Roman, Times, serif"><em><strong><%=rs.getString(10)%></strong></em></font></td></tr>
        </table>
