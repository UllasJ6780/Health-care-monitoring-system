...
%>
  ...
  <form name="form1"  method="post" action="patientbill1.jsp" onSubmit="return valid(this)"  >
  <p align="center"><strong><font color="#003399" size="5" face="Times New Roman">Day Billing Details</font></strong></p>
  
  <p align="center">&nbsp;</p>
  <table width="381" border="0" align="center" cellpadding="2" cellspacing="2">
    <tr> 
      <td width="165"><div align="center"><font size="4" face="Times New Roman"><em><strong>Enter-Date</strong></em></font></div></td>
      <td width="192"><font size="5"> 
        <input  type="text"  name="did" id="id"/>&nbsp; &nbsp;<b style="color:gray">Ex : Thu Feb 11</b><br/>
        </font></td>
    </tr>
